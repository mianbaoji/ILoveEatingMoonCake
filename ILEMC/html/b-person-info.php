                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        <a href="#" class="btn btn-default dropdown-toggle" data-toggle="dropdown">
                            <img src="../images/photos/user.png" alt=""/> <!--用户头像...待定功能= =-->
                        ...
                        <div class="panel-body">
                            <div class="col-md-4">
                                <div class="profile-pic text-center">
                                    <img alt=" " src="../images/photos/user.png"/>
                                </div>
                            </div>
                            <div class="col-md-6">
                            ...
                            <div aria-hidden="true" aria-labelledby="myModalLabel" role="dialog" tabindex="-1"
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        $nowuserid = $_SESSION['userid'];
                                        $sql = "select `username`,`tel`,`email` from `user` where id=$nowuserid";
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button data-dismiss="modal" class="btn btn-primary" type="button">确定
                                            </button>
