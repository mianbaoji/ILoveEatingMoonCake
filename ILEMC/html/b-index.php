            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list"><a href=""><i class="fa fa-tasks"></i> <span>活动管理</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li><a href="b-activity-approve.html"> 审批活动</a></li>
                ...
                <ul class="notification-menu">
                    ...
                    <li>
                        ...
                        <ul class="dropdown-menu dropdown-menu-usermenu pull-right">
                            ...
                            <li><a href="../login.php"><i class="fa fa-sign-out"></i> 注销登陆
                                    <?php
                                    //session_destroy();
                                    ?>
                                </a></li>
			...
			<div class="row">
                <div class="col-md-12">
                    ...
                    <div class="row state-overview">
						...
						<a href="b-activity-approve.html" style="text-decoration:none; color:#fff;">
						<div class="col-md-4 col-xs-12 col-sm-4">
