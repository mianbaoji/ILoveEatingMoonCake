            ...
            <ul class="nav nav-pills nav-stacked custom-nav">
                ...
                <li class="menu-list nav-active"><a href=""><i class="fa fa-tasks"></i> <span>活动管理</span></a>
                    <ul class="sub-menu-list">
                        ...
                        <li class="active"><a href="b-activity-new.php"> 新建活动</a></li>
                ...
                <div class="col-md-12">
                    <section class="panel">
                        ...
                        <div class="panel-body">
                            <form action="b-activity-info.php" class="form-horizontal " method="get">
                                <div class="form-group">
                                    <div class="col-md-12">
                                        <label for="InputName">活动名称</label>
                                        <input name="name" type="text" class="form-control" id="InputName" placeholder="活动名称不可为空"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-12">
                                        <label for="ResponseName">活动负责人</label>
                                        <input name="people" type="text" class="form-control" id="InputPerson" placeholder="活动负责人不能为空"/>
                                    </div>
                                </div>
                                <div class="form-group">
                                    <div class="col-xs-6">
                                        <label for="ResponseName">活动开始时间</label>
                                        <input name="starttime" type="date" class="form-control" id="InputSTime" placeholder="开始时间不能为空"/>
                                    </div>
                                    <div class="col-xs-6">
                                        <label for="ResponseName">活动结束时间</label>
                                        <input name="endttime" type="date" class="form-control" id="InputETime" placeholder="结束时间不能为空"/>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-12">
                                        ...
                                        <textarea name="contain" class="wysihtml5 form-control" rows="9" id="InputContent" placeholder="活动内容不可为空"></textarea>
                                    </div>
                                </div>
